...
# Set up the GPIO mode and pin (use BOARD mode for physical pin numbering)
GPIO.setmode(GPIO.BOARD)  # Use BOARD mode for physical pin numbers
GPIO.setup(18, GPIO.OUT)  

# Set up PWM on pin 12 (physically GPIO 18)
pwm = GPIO.PWM(12, 1000)  # Initial frequency set to 1000 Hz (this will be adjusted later)
